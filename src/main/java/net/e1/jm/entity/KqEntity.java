...
import net.e1.jm.procedures.KqtickProcedure;
import net.e1.jm.procedures.KqspawnedProcedure;
import net.e1.jm.procedures.KqcollideProcedure;
import net.e1.jm.procedures.KqclickedProcedure;
import net.e1.jm.JmModElements;

import com.mojang.blaze3d.platform.GlStateManager;

@JmModElements.ModElement.Tag
public class KqEntity extends JmModElements.ModElement {
	public static EntityType entity = null;
	public KqEntity(JmModElements instance) {
		super(instance, 26);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f)).build("kq")
						.setRegistryName("kq");
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public ILivingEntityData onInitialSpawn(IWorld world, DifficultyInstance difficulty, SpawnReason reason, ILivingEntityData livingdata,
			...
			Entity entity = this;
			{
				...
				KqspawnedProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public boolean processInteract(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				KqclickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
				KqtickProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			int z = (int) this.posZ;
			{
				...
				$_dependencies.put("entity", entity);
				$_dependencies.put("sourceentity", sourceentity);
				KqcollideProcedure.executeProcedure($_dependencies);
			}
		}
