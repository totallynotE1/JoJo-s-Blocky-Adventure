...
public class TogglepowersKeyBinding extends JmModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public TogglepowersKeyBinding(JmModElements instance) {
		super(instance, 24);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.togglepowers", GLFW.GLFW_KEY_C, "key.categories.jojosblockyadventure");
