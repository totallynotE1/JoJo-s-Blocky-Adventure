...
public class TurnonoffstandKeyBinding extends JmModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public TurnonoffstandKeyBinding(JmModElements instance) {
		super(instance, 25);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.turnonoffstand", GLFW.GLFW_KEY_V, "key.categories.jojosblockyadventure");
