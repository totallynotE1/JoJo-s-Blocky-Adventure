...
public class Jmattack1Potion extends JmModElements.ModElement {
	@ObjectHolder("jm:jmattack_1")
	public static final Effect potion = null;
	public Jmattack1Potion(JmModElements instance) {
		super(instance, 36);
